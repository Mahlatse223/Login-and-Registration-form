    ...
    <form className="max-w-md mx-auto mt-10 bg-white p-6 rounded-lg shadow-md">
      <div>
       ...
       <div>
        ...
        <div>
          <label htmlFor="" className="block text-sm font-medium text-gray-700 mb-1">Surname</label>
          <input type="text"
          id="name"
        ...
        <div>
          <label htmlFor="" className="block text-sm font-medium text-gray-700 mb-1">Number</label>
          <input  type="tel"
          id="tel"
          placeholder="Number"
          className="w-full border border-gray-300 rounded-lg px-3 py-2 text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500" 
          onChange={(e) => {
            e.target.value = e.target.value.replace(/[^0-9+\-\s]/g, ""); // Allow only digits, +, -, and spaces
          }}/>
        </div>
      ...
      <input
        ...
        onChange={togglePasswordVisibility} />
         ...
         <div className= "flex items-center mt-3 ">
          <h2 className="text-sm text-gray-700">Already have account?</h2>
          <h2 className="text-sm text-blue-500 pl-1">
          <Link href="/login-reg/login">Sign in</Link>
          </h2>
         </div>
        </div>
     </div>
